    ...
    onClick_Add: function () {
        if (this.raddcur != null)
        {
            if (this.raddcur.name == '') {
                ...
                ss4.alert({ title: 'Thông báo', message: 'Vui lòng nhập tên phòng ban và thực hiện lại!!!', width: 300, height: 150, icon: 'info', time: 5000 });
                return false;
            }
        }
...
$(document).ready(function () {
    $('#breadcrumb').html('Danh mục <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Đơn vị phòng ban');
