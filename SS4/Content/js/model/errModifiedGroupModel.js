var viewModel = kendo.observable({
    ...
    onClick_Save: function () {
        ...
        if (para.length != 0) {
            ...
            $.ajax({
                type: "POST",
                url: "/errmodifiedgroup/CreateOrUpdate",
                data: params,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (e) {
...
$(document).ready(function () {
    $('#breadcrumb').html('Danh mục <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Nhóm lỗi + lỗi lựa lại');
