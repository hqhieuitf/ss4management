...
{
    public class clsModifiedDetailByMaster
    {
    ...
    public class clsModifiedDataMrgMaster
    {
        ...
        {
            return clsDBUtil.getCategorie("tblmodifieddataforform", false, MasterId);
        }
        ...
        public int InsertOrUpdate()
        {
            ...
            (arrPara[13] = new SqlParameter("@sheet", SqlDbType.Int)).Value = sheet;
            SqlHelper.ExecuteNonQuery(SqlHelper.ConnectionString, CommandType.StoredProcedure, "usp_tblModifiedDataMrgMaster_insertorupdate", arrPara);
        ...
        public void Delete()
        {
            ...
            (arrPara[0] = new SqlParameter("@id", SqlDbType.Int)).Value = id;
            SqlHelper.ExecuteNonQuery(SqlHelper.ConnectionString, CommandType.StoredProcedure, "usp_tblModifiedDataMrgMaster_delete", arrPara);
        }


    }
    public class clsModifiedDataMrgDetail
    {
        ...
        public void Insert()
        {
            ...
            (arrPara[4] = new SqlParameter("@itype", SqlDbType.Int)).Value = itype;
            SqlHelper.ExecuteNonQuery(SqlHelper.ConnectionString, CommandType.StoredProcedure, "usp_tblModifiedDataMrgDetail_insert", arrPara);
        }
